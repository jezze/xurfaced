...
halo:
	...
	clang -Wall -lm -lpthread `pkg-config --libs x11 xrender xcomposite cairo` src/client.o src/display.o src/event.o src/halo.o src/menu.o src/surface.o src/window.o -o halo

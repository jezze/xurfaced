...
xurfaced:
	...
	gcc -Wall -lm -lpthread `pkg-config --libs x11 xrender xcomposite cairo` src/limb/llist.o src/client.o src/display.o src/event.o src/xurfaced.o src/menu.o src/render.o src/window.o -o xurfaced

...
halo:
	clang -Wall -I./include `pkg-config --cflags x11 xrender xcomposite cairo` -c src/limb/llist.c -o src/limb/llist.o
	...
	clang -Wall -lm -lpthread `pkg-config --libs x11 xrender xcomposite cairo` src/limb/llist.o src/client.o src/display.o src/event.o src/halo.o src/menu.o src/surface.o src/window.o -o halo
